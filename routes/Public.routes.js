...
const { paymentStatus, paymentStatusActual, reconcileTransactions } = require('../controllers/Payment.controller')
...
router.get('/reconcileTransactions', reconcileTransactions);
